...
Electrum mode is available for utxo-based and QRC20-based coins only; this includes Bitcoin and Bitcoin-based forks. Electrum mode is not available for ETH/ERC20.
...
#### Command (For QRC20-based blockchains)
