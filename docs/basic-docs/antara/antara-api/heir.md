...
```json
{"result":{"result":"error","error":"can't find any heir CC funding transactions"},"error":null,"id":"curltest"}
```
...
```json
{"result":{"result":"success","HeirCCAddress":"RDVHcSekmXgeYBqRupNTmqo3Rn8QRXNduy","HeirCCBalance":0.00000000,"HeirNormalAddress":"RTPwUjKYECcGn6Y4KYChLhgaht1RSU4jwf","HeirNormalBalance":0.00000000,"HeirCC1of2Address":"RNiTPVRGjACeEuUrLEY41J6MZCawqHWxeW","HeirCC1of2TokensAddress":"RQRveLpdFHRPpYYmgFRh655QwfPrpgdBNh","PubkeyCCaddress(Heir)":"RTF9g6SRzbgZXTT7arGZrmTeNKuLoGYyZA","PubkeyCCbalance(Heir)":0.00000000,"myCCAddress(Heir)":"RSSHjV5DeBBYzYXAoiLFcTudFZ2UyW6S72","myCCbalance(Heir)":0.00000000,"myaddress":"RPCeZmqW4Aam52DFLmMraWtu5CuXPxqk92","mybalance":0.00000000},"error":null,"id":"curltest"}
```
...
```json
{"result":null,"error":{"code":-3,"message":"Expected type bool, got string"},"id":"curltest"}
```
...
```json
{"result":{"result":"success","hex":""},"error":null,"id":"curltest"}
```
...
```json
{"result":null,"error":{"code":-26,"message":"16: tx-overwinter-expired"},"id":"curltest"}
```
...
```json
{"result":{"result":"error","error":"could not find heir cc plan for this txid (no initial tx)"},"error":null,"id":"curltest"}
```
