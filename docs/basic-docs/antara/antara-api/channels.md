...
```bash
curl --user $rpcuser:$rpcpassword --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method":"channelsclose", "params":["2f95b0f4e3dbe7f5ebc0f9479800c9ff3f44e76f5378313c9406ab5a92ff4631"]}' -H 'content-type: text/plain;' http://127.0.0.1:$rpcport/
```
...
```json
{
  "result": "2f95b0f4e3dbe7f5ebc0f9479800c9ff3f44e76f5378313c9406ab5a92ff4631",
  "error": null,
  "id": "curltest"
}
```
...
```json
{
  "result": "36008a42bf65d62e5433ff9de72ccf3becc6d243120b2627b504bc327198bc37",
  "error": null,
  "id": "curltest"
}
```
