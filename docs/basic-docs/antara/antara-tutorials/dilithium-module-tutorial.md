...
The above Q transaction was relatively simple. Let's move to a more complex Q transaction. 

We now send a Qsend transaction with outputs to multiple R addresses and multiple Dilithium handles.
