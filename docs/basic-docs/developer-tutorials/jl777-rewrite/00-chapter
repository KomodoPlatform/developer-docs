# Building a New Fluidity Module

The following content is provided for the experienced C++ developer who has read the book, Mastering Bitcoin, and desires to employ the Custom Consensus framework to create new modules. 

At this stage, the developer should be aware of basic blockchain concepts, such as the consensus mechanism, the approximate nature of how transactions are performed and recorded, and the basic meaning of the word, "decentralization."

The CC developer does not need to thoroughly understand all aspects of the Bitcoin protocol to 

With these concepts established, we now turn to a more in-depth approach to a few Bitcoin-protocol concepts that must be thoroughly understoo
